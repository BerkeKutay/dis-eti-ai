...
hf_hub_download(repo_id="Kutay0/dis-eti-ai", filename="yolo/best.pt", local_dir=".", repo_type="model")

print("LLM modeli indiriliyor...")
hf_hub_download(repo_id="Kutay0/dis-eti-ai", filename="llm/dental_model.pt", local_dir=".", repo_type="model")
